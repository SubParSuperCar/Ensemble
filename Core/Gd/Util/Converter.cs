...
public static class Converter
{
	...
	public static Variant ToGodot(this Api.Asset.Variant variant) => variant.Type switch
	{
	...
	public static Api.Asset.Variant FromGodot(this Variant variant) => variant.VariantType switch
	{
