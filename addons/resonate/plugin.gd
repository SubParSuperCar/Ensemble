...
func _enter_tree():
	...
	add_custom_type("SoundBank", "Node", preload("sound_manager/sound_bank.gd"),
		preload("sound_manager/sound_bank.svg"))
	add_custom_type("MusicBank", "Node", preload("music_manager/music_bank.gd"),
		preload("music_manager/music_bank.svg"))
...
func add_project_setting(p_name: String, p_default, p_actual, p_type: int, p_hint: int=PROPERTY_HINT_NONE,
